...
public class printPdf {
    public static void printThis(String pdfFileName, ArrayList<String> fName,
        ...
        try {
            ...
            System.out.println("Error 1: "+ dsa);
        } catch(DocumentException asd){
            System.out.println("Error 2: "+ asd);
        } catch(ExceptionConverter sda){
            System.out.println("Error 3: "+ sda);
        }
    }
}
